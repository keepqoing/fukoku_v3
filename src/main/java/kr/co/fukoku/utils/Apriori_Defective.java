...
public class Apriori_Defective {
    ...
    final static double MIN_CONF = 0.1;// minimum confidence
...
//            System.out.println();
    ...
    private static boolean haveThisItem3(FaultLink link) {
        ...
        if ((a.equals("라인") && b.equals("차종")) ||
                (a.equals("차종") && b.equals("불량유형")) ||
                (a.equals("불량유형") && b.equals("발생장소")) ||
                (a.equals("발생장소") && b.equals("불량원인")) ||
                (a.equals("불량원인") && b.equals("조립상태")))
            return true;

        else if ((a.equals("차종") && b.equals("라인")) ||
                (a.equals("불량유형") && b.equals("차종")) ||
                (a.equals("발생장소") && b.equals("불량유형")) ||
                (a.equals("불량원인") && b.equals("발생장소")) ||
                (a.equals("조립상태") && b.equals("불량원인"))) {
