...
public class ProcessChain {
    ...
    public ProcessChain(long id, int seq, String name, String ref_line, List<ProcessProductFrm> process_product, List<ProcessChainElementModelFrm> process_chain_element) {
        this.id = id;
        this.seq = seq;
        this.name = name;
