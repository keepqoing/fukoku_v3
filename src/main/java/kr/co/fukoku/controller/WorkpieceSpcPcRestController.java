...
@RestController
@RequestMapping("/v3/api/fukoku/workpiece-spc")
public class WorkpieceSpcPcRestController {
	
	@Autowired
	private WorkpieceSpcPcService service;
    ...
    public ResponseEntity<Map<String,Object>> realTime(@RequestBody WorkpieceIndexing wp) throws ParseException  {
        return new ResponseEntity<Map<String,Object>>(service.workpieceControlChartAndProcessCapability(wp), HttpStatus.OK);
    }
