/****************************************
 *  jQuery ä¸Šä¸‹æ–‡èœå•æ’ä»¶ï¼Œæ”¯æŒå¤šçº§èœå•å’Œå›¾æ ‡æ˜¾ç¤ºï¼Œ
 *  è‡ªå®šä¹‰æ ·å¼å®žçŽ°çµæ´»æŽ§åˆ¶èœå•é£Žæ ¼
 *
 *  åœ¨ MTI è®¸å¯ä¸‹ï¼Œå¯è‡ªç”±åˆ†å‘ã€ä¿®æ”¹ã€å¤åˆ¶è¯¥ä»£ç ã€‚
 *  å¯ä»¥åœ¨ä½ çš„é¡¹ç›®ï¼ˆä¸é™äºŽå•†ä¸šç›ˆåˆ©æ€§é¡¹ç›®ï¼‰ä¸‹å…è´¹
 *  ä½¿ç”¨æºç 
 *
...
;(function ($) {
    ...
    $.fn.contextMenu = function (data, options) {
        var $body = $("body"), defaults = {name: "", offsetX: 15, offsetY: 5, beforeShow: $.noop, afterShow: $.noop};
