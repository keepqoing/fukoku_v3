$(function () {
    ...
    alarmStatistics.getAlarmData = function (factory, line, machine, year, callback) {
        openLoading();
        $.ajax({
            url: "/v1/api/fukoku/alarm-statistics/duration/"+factory+"/"+line+"/"+machine+"/"+year,
            type: 'GET',
            dataType: 'JSON',
            data:{},
            beforeSend: function(xhr) {
    ...
    alarmStatistics.getAlarmDataSum = function (factory, line, machine, year, callback) {
        ...
        $.ajax({
            url: "/v1/api/fukoku/alarm-statistics/sum/duration/"+factory+"/"+line+"/"+machine+"/"+year,
            type: 'GET',
            dataType: 'JSON',
            data:{},
            beforeSend: function(xhr) {
    ...
    // alarmStatistics.getAlarmData('ALL','ALL','ALL','2018')
    // ===================================================================================
