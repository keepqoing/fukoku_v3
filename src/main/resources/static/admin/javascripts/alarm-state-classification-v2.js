$(function () {
            ...
            success: function(response) {
                ...
                if(response.CODE == "7777"){
                    ...
                    for (var i = 0; i < response.DATA.length; i++) {
                        var my_object = {};
                        my_object.key = i;
                        my_object.country = "("+i+")."+response.DATA[i].MACHINE+ "["+response.DATA[i].ALARM_NAME+"]";
                        my_object.value = response.DATA[i].FREQUENCY;
                        my_object.ALARM = response.DATA[i].ALARM_NAME;
                        data.push(my_object);
                    }
                    //if(isUpdate == false){
                        alarmCls.init(data);
    ...
    alarmCls.init = function (dataGraph) {
        $("#chart").empty();
        ...
        var main_margin = {top: 10, right: 10, bottom: 30, left: 350},
