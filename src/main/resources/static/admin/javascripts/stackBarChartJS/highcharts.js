    ...
    (function (a) {
        ...
        a.AxisPlotLineOrBandExtension = {
            getPlotBandPath: function (a, f) {
                ...
                for (var k = this.plotLinesAndBands, d = this.options, c = this.userOptions,
    ...
    (function (a) {
        ...
        B.prototype.getLogTickPositions =
            function (a, l, q, k) {
                ...
                if (.5 <= a) a = Math.round(a), z = this.getLinearTickPositions(a, l, q); else if (.08 <= a)for (var d = Math.floor(l),
                                                                                                                     b,
                                                                                                                     p,
                                                                                                                     h,
                                                                                                                     t,
                                                                                                                     D,
                                                                                                                     f = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; d < q + 1 && !D; d++)for (p = f.length, b = 0; b < p && !D; b++)h = n(c(d) * f[b]), h > l && (!k || t <= q) && void 0 !== t && z.push(t), t > q && (D = !0), t = h; else l = c(l), q = c(q), a = f[k ? "minorTickInterval" : "tickInterval"], a = r("auto" === a ? null : a, this._minorAutoInterval,
    ...
    (function (a) {
        ...
        B.prototype = {
            init: function (a, c, f) {
                ...
                for (var a = ["graphic",
                        "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], c,
                         f = 6; f--;)c = a[f], this[c] && (this[c] = this[c].destroy())
