...
// define the 4th line
    ...
    // define the 5th line -- byPassedProductRate
    var valueline5 = d3.line()
        .x(function(d) { return xLine(d.year); })
        .y(function(d) { return yLine(d.line6); });
...
// moves the 'group' element to the top left margin
    ...
    // Add the valueline5 path. -- byPassedProduct
    svg.append("path")
        .data([data])
        .attr("class", "line")
        .style("stroke", "#AC58FA")
    ...
    /***
     * byPassedProductRate line chart
     */
    ...
    points5.enter().append("circle")
        ...
        .style("fill", "#AC58FA")
        .attr("cx", function(d){ return xLine(d.year); })
        .attr("cy", function(d){ return yLine(d.line6); })
        .attr("r", function(d){ return 5; });
