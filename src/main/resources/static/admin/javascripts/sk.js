        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            module.exports = Base.extend("Sankey", {
                        ...
                        events: {
                            "enter": function () {
                                this.on("mouseover", function (e) {
                                    chart.trigger("link:mouseover", e);
                                });
                                this.on("mouseout", function (e) {
                                    chart.trigger("link:mouseout", e);
                                });
                                this.on("click", function (e) {
                                    chart.trigger("link:click", e);
                                });
                            },
                    ...
                    chart.layer("nodes", chart.layers.nodes, {
                        ...
                        events: {
                            "enter": function () {
                                ...
                                this.on("mouseover", function (e) {
                                    chart.trigger("node:mouseover", e);
                                });
                                this.on("mouseout", function (e) {
                                    chart.trigger("node:mouseout", e);
                                });
                                this.on("click", function (e) {
                                    chart.trigger("node:click", e);
                                });
                            },
                            ...
                            "merge": function () {
                                ...
                                this.select("rect")
                                    ...
                                    .style("stroke", function (d) {
                                        return d3.rgb(colorNodes(d)).darker(2);
                                    });
                                ...
                                this.select("text")
                                    ...
                                    .attr("x", function (d) {
                                        return textAnchor(d) === "start" ? (6 + chart.features.nodeWidth) : -6;
                                    })
                ...
                iterations: function (_) {
                    if (!arguments.length) {
                        return this.features.iterations;
                    }
                ...
                nodeWidth: function (_) {
                    if (!arguments.length) {
                        return this.features.nodeWidth;
                    }
                ...
                nodePadding: function (_) {
                    if (!arguments.length) {
                        return this.features.nodePadding;
                    }
                ...
                alignLabel: function (_) {
                    if (!arguments.length) {
                        return this.features.alignLabel;
                    }
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            d3.sankey = function () {
                ...
                function computeNodeLinks() {
                    ...
                    nodes.forEach(function (node) {
                        if (node.sourceLinks.length == 0)
                            delete node.sourceLinks;
                        if (node.targetLinks.length == 0)
                            delete node.targetLinks;
                    });
                ...
                function computeNodeValues() {
                    nodes.forEach(function (node) {
                        var a = 0, b = 0;
                        if (node.hasOwnProperty('sourceLinks'))
                            a = d3.sum(node.sourceLinks, value);
                        else a = 0;

                        if (node.hasOwnProperty('targetLinks'))
                            b = d3.sum(node.targetLinks, value);
                        else b = 0;

                        node.value = Math.max(a, b);
                    });
                }
                ...
                function computeNodeDepths(iterations) {
                    ...
                    function initializeNodeDepth() {
                        // var ky = d3.scale.linear().domain([d3.min(nodesByBreadth,function(d){return d.length;}),
                        //     d3.max(nodesByBreadth,function(d){return d.length;})])
                        //     .range()
                        ...
                        var ky = d3.min(nodesByBreadth, function (nodes) {
                            ...
                            return ((size[1]-20) - (len-1) * nodePadding) / d3.sum(nodes, value);
                        });
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            module.exports = Chart("Sankey.Base", {
                ...
                colorNodes: function (_) {
                    if (!arguments.length) {
                        return this.features.colorNodes;
                    }
                ...
                colorLinks: function (_) {
                    if (!arguments.length) {
                        return this.features.colorLinks;
                    }
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            module.exports = Sankey.extend("Sankey.Selection", {
                ...
                initialize: function () {
                    ...
                    chart.on("link:mouseout", function () {
                        chart.selection(null);
                    });
                    chart.on("node:mouseover", chart.selection);
                    chart.on("node:mouseout", function () {
                        chart.selection(null);
                    });
                ...
                selection: function (_) {
                    if (!arguments.length) {
                        return this.features.selection;
                    }
                ...
                unselectedOpacity: function (_) {
                    if (!arguments.length) {
                        return this.features.unselectedOpacity;
                    }
        ...
        /***/ function (module, exports, __webpack_require__) {
            ...
            module.exports = Selection.extend("Sankey.Path", {
                ...
                selection: function (_) {
                    ...
                    if (!arguments.length) {
                        return chart.features.selection;
                    }
            ...
            function getConnectionsNode(o, direction) {
                ...
                if(o.hasOwnProperty("sourceLinks") && o.hasOwnProperty("targetLinks")) {
